    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-8">
                    <h3><span class="badge badge-info" style="">MOVIMIENTOS DE CAJA</span></h3>
                </div>
            </div>
        </div>
                ...
                <div class="col-9" style="padding:4px 0px;">
                    <nav class="navbar navbar-light">
                        <form class="form-inline">
                            <input class="form-control mr-sm-2" id="movimientos_buscar" type="date" style="width:360px;" placeholder="Buscar movimientos de caja" aria-label="Search" oninput="caja.listarMovimientos($(this).val());">
                            <button class="btn btn-outline-success my-2 my-sm-0" type="button" onClick="caja.listarMovimientos($('#movimientos_buscar').val());"><i class="fas fa-search"></i> Buscar</button>
                        </form>
                    </nav>
                </div>
                <div class="col-sm-3" style="padding:9px 16px;">
                    <button type="button" class="btn btn-block btn-success" style="float:right;" data-toggle="modal" data-target="#modal-add" onclick='btn_add_movimientos();'>Añadir <i class="fas fa-plus"></i></button>
                </div>
                <div class="w-100"></div>
                <div class="col">
                    ...
                    <div id="load_table_movimientos"></div>
