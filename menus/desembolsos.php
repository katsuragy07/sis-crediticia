                                    ...
                                    <div class="row">
                                        <div class="col-md-5">  
                                            ...
                                            <div class="form-group row" style="margin-bottom:0.5em;">
                                                <label for="sol_MONTO" class="col-sm-5 col-form-label"><span class="badge badge-pill badge-success" style="font-size:16px;margin-top:6px;">*Monto a desembolsar</span></label>
                                                <div class="col-sm-7">
                                                    <input type="number" step="any" class="form-control" id="sol_MONTO" name="sol_MONTO" placeholder="Monto del crédito" required readonly>
                                                </div>
                                            </div>
                                            <div class="form-group row" style="margin-bottom:0.5em;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12" id="print-cronograma">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <center><h4 class="cronograma-letra" style="margin-top:20px; font-size:1.3em;"><b>CALENDARIO DE PAGOS</b></h4></center>
                                    </div>
                                    <div class="col-4">
                                        <table class="cronograma-letra" style="font-family:arial; float:right;" id="cronograma-datos01">
                                            <tr>
                                                <td> COD. CLIENTE</td>
                                                <td>:</td>
                                                <td>456</td>
