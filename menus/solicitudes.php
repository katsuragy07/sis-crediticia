<?php
    ...
    if(substr($accesos['creditos'],0,1) == 0){
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-8">
                    <h3><span class="badge badge-info">SOLICITUDES DE CRÉDITO</div></h3>
                </div>
            </div>
        </div>
                ...
                <div class="col-9" style="padding:4px 0px;">
                    <nav class="navbar navbar-light">
                        <form class="form-inline">
                            <select class="form-control mr-sm-2" id="solicitudes_buscar_tipo">
                                <option value="NOMBRE" selected>NOMBRE</option>
                                <option value="DNI">DNI</option>
                            </select>
                            <input class="form-control mr-sm-2" id="solicitudes_buscar" type="search" style="width:360px;" placeholder="Buscar solicitudes por cliente" aria-label="Search" oninput="credito.buscar_solicitud($(this).val());">
                            <button class="btn btn-outline-success my-2 my-sm-0" type="button" onClick="credito.buscar_solicitud($('#solicitudes_buscar').val());"><i class="fas fa-search"></i> Buscar</button>
                        </form>
                    </nav>
                </div>
                <div class="col-sm-3" style="padding:9px 16px;">
                    <button type="button" class="btn btn-block btn-success" style="float:right;" data-toggle="modal" data-target="#modal-add" onclick='btn_add_credito("solicitud");'>Añadir <i class="fas fa-plus"></i></button>
                </div>
                <div class="w-100"></div>
                <div class="col">
                    <table class="table table-striped table-bordered">
                        <thead class="thead-dark text-center">
                            <tr>
                                ...
                                <th scope="col">Fecha de pre-aprobación</th>
                                <th scope="col">Estado</th>
                                <th scope="col">Operaciones</th>
                            </tr>
                        </thead>
                        <tbody id="load_data_solicitudes">
                            
                        </tbody>
                    </table>

                    <div id="load_table_solicitudes"></div>
                    ...
                    <div class="container-fluid modal-body" style="padding:15px;">
                        <div class="row justify-content-center"> 
                            <div class="col-md-12">
                                ...
                                <form id="formulario-solicitud" class="formulario-modal" enctype="multipart/form-data">
                                    <h4 style="margin-bottom:18px;">REGISTRAR SOLICITUD DE CRÉDITO</h4>
                                    <hr>                           
                                    <div class="row">
                                        <div class="col-lg-5">              
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value="SI" id="inputCONY" name="inputCONY">
                                                        <label class="form-check-label" for="inputCONY">
                                                            Conyugue
                                                        </label>
                                                    </div>
                                                    <div class="w-100" style="height:7px;"></div>
                                                    <input list="conyugue-list-ajax" type="text" class="form-control form-control-sm" id="inputCONY_AJAX" name="inputCONY_AJAX" placeholder="Conyugue" readonly autocomplete="off" onKeyUp="credito.buscarConyugue(this.value);">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value="SI" id="inputAVAL" name="inputAVAL">
                                                        <label class="form-check-label" for="inputAVAL">
                                                            Aval
                                                        </label>
                                                    </div>
                                                    <div class="w-100" style="height:7px;"></div>
                                                    <input list="aval-list-ajax" type="text" class="form-control form-control-sm" id="inputAVAL_AJAX" name="inputAVAL_AJAX" placeholder="Aval" readonly autocomplete="off" onKeyUp="credito.buscarAval(this.value);">
                                            ...
                                            <div class="form-group row" style="margin-bottom:0.5em;">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea class="form-control form-control-sm" id="sol_NEGOCIO" name="sol_NEGOCIO" placeholder="" rows="4"></textarea>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-5">              
                                            ...
                                            <div class="form-group row" style="margin-bottom:0.5em;">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea class="form-control form-control-sm" id="sol_NEGOCIO-w" name="sol_NEGOCIO-w" placeholder="" rows="5" required readonly></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row" style="margin-bottom:0.5em;">
                                                <label for="sol_PREAPROB-w" class="col-sm-4 col-form-label">*Fecha de pre-aprobación</label>
                                                <div class="col-sm-8">
                                                    <input type="date" class="form-control form-control-sm" id="sol_PREAPROB-w" name="sol_PREAPROB-w" placeholder="Fecha de pre-aprobación" required readonly>
                                                </div>
                                            </div>
