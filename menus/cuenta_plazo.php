    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-8">
                    <h3><span class="badge badge-info">CUENTA A PLAZO FIJO</div></h3>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="row justify-content-end">
                ...
                <div class="col-sm-3" style="padding:9px 16px;">
                    <button type="button" class="btn btn-block btn-success" style="float:right;" data-toggle="modal" data-target="#modal-add" onclick='btn_add_cuenta("pf");'>Añadir <i class="fas fa-plus"></i></button>
                </div>
                <div class="w-100"></div>
                <div class="col">
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody id="load_data_cuenta_pf">
                            
                        </tbody>
                    </table>

                    <div id="load_table_cuenta_pf"></div>
                    ...
                    <div class="container-fluid modal-body" style="padding:15px;">
                        <div class="row justify-content-center"> 
                            <div class="col-md-12">
                                ...
                                <form id="formulario-cuenta_pf" class="formulario-modal" enctype="multipart/form-data">
