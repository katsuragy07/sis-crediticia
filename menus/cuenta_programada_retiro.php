    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-8">
                    <h3><span class="badge badge-info">RETIRO DE CUENTA A PLAZO PROGRAMADO</div></h3>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-end">
                ...
                <div class="col">
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody id="load_data_cuenta_pp_retiro">
                            
                        </tbody>
                    </table>

                    <div id="load_table_cuenta_pp_retiro"></div>
                    ...
                    <div class="container-fluid modal-body" style="padding:15px;">
                        <div class="row justify-content-center"> 
                            <div class="col-md-12">
                                ...
                                <form id="formulario-cuenta_pp_retiro" class="formulario-modal" enctype="multipart/form-data">
