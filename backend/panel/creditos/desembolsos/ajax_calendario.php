...
switch($_GET['consulta']){
    case 'buscar': $query = "
                            SELECT iddesembolso, idcliente, us_ases.idusuario as idases, us_adm.idusuario as idadm, us_caja.idusuario as idcaja, idcredito, idsolicitud, conyugue.idconyugue AS idconyugue, aval.idconyugue AS idaval, clientes.nombre AS cli_nombre, clientes.apellido_pat AS cli_apellido_pat, clientes.apellido_mat AS cli_apellido_mat, clientes.telefono AS cli_telefono, clientes.direccion AS cli_direccion,
    ...
    case 'editar': $id = $_GET['id'];
                   $query = "
                            SELECT iddesembolso, idcliente, us_ases.idusuario as idases, us_adm.idusuario as idadm, us_caja.idusuario as idcaja, idcredito, idsolicitud, conyugue.idconyugue AS idconyugue, aval.idconyugue AS idaval, clientes.telefono AS cli_telefono, clientes.direccion AS cli_direccion,
                            clientes.nombre AS cli_nombre, clientes.apellido_pat AS cli_apellido_pat, clientes.apellido_mat AS cli_apellido_mat, clientes.dni AS cli_dni,
                            us_ases.nombre AS usu_ases_nombre, us_ases.apellido_pat AS usu_ases_apellido_pat, us_ases.apellido_mat AS usu_ases_apellido_mat, us_ases.telefono AS usu_ases_telefono,
                            us_adm.nombre AS usu_adm_nombre, us_adm.apellido_pat AS usu_adm_apellido_pat, us_adm.apellido_mat AS usu_adm_apellido_mat,
                            us_caja.nombre AS usu_caja_nombre, us_caja.apellido_pat AS usu_caja_apellido_pat, us_caja.apellido_mat AS usu_caja_apellido_mat,
                            conyugue.nombre AS con_nombre, conyugue.apellido_pat AS con_apellido_pat, conyugue.apellido_mat AS con_apellido_mat, aval.nombre AS ava_nombre, aval.apellido_pat AS ava_apellido_pat, aval.apellido_mat AS ava_apellido_mat, monto_prop, monto_aprob, n_cuotas, n_cuotas_aprob, interes, interes_aprob, frecuencia, fecha_inicio, m_cuotas, m_cuotas_aprob, m_interes, m_interes_aprob, m_total, m_total_aprob, estado, nro_credito,
