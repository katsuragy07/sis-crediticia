...
switch($_GET['consulta']){
    ...
    case 'editar': $id = $_GET['id'];
                   $query = "
                            ...
                            us_adm.nombre AS usu_adm_nombre, us_adm.apellido_pat AS usu_adm_apellido_pat, us_adm.apellido_mat AS usu_adm_apellido_mat,
                            us_caja.nombre AS usu_caja_nombre, us_caja.apellido_pat AS usu_caja_apellido_pat, us_caja.apellido_mat AS usu_caja_apellido_mat,
                            conyugue.dni AS con_dni, conyugue.nombre AS con_nombre, conyugue.apellido_pat AS con_apellido_pat, conyugue.apellido_mat AS con_apellido_mat, aval.dni AS ava_dni, aval.nombre AS ava_nombre, aval.apellido_pat AS ava_apellido_pat, aval.apellido_mat AS ava_apellido_mat, monto_prop, monto_aprob, n_cuotas, n_cuotas_aprob, interes, interes_aprob, frecuencia, DATE_FORMAT(fecha_inicio,'%d-%m-%Y') AS fecha_inicio,DATE_FORMAT(fecha_inicio,'%d de %M del %Y') AS fecha_inicio_nombre, m_cuotas, m_cuotas_aprob, m_interes, m_interes_aprob, m_total, m_total_aprob, estado,
