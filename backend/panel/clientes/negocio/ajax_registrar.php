<?php
    ...
    */
    ...
    if($resultadoUP){
        $query = "INSERT INTO negocio(norm_tipo,norm_tipo_local,norm_tipo_negocio,trans_tipo,trans_placa,trans_empresa,trans_direccion,trans_soat,trans_soat_cad,trans_tarjeta,trans_tarjeta_cad,tiempo,tipo,clientes_idcliente,url_croquis) VALUES ('$norm_tipo','$norm_tipo_local','$norm_tipo_negocio','$trans_tipo','$trans_placa','$trans_empresa','$trans_direccion','$trans_soat','$trans_soat_cad','$trans_tarjeta','$trans_tarjeta_cad','$tiempo','$tipo','$id_cliente','$uploadedFile');";   
    }else{
        $query = "INSERT INTO negocio(norm_tipo,norm_tipo_local,norm_tipo_negocio,trans_tipo,trans_placa,trans_empresa,trans_direccion,trans_soat,trans_soat_cad,trans_tarjeta,trans_tarjeta_cad,tiempo,tipo,clientes_idcliente) VALUES ('$norm_tipo','$norm_tipo_local','$norm_tipo_negocio','$trans_tipo','$trans_placa','$trans_empresa','$trans_direccion','$trans_soat','$trans_soat_cad','$trans_tarjeta','$trans_tarjeta_cad','$tiempo','$tipo','$id_cliente');";   
        $resultadoUP = true;
    }
